---
title: Deploying TastefulKit to Render
description: Learn how to deploy TastefulKit on Render.
keywords: TastefulKit, deployment, render, self-hosting
author: LVTD, LLC
---

[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/LVTD-LLC/tastefulkit)
