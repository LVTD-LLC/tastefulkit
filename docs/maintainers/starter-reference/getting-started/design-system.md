...
For implementation details, also read `.agents/skills/frontend-ui-quality/SKILL.md`. It captures the generated project's portable UI quality bar for Django templates, Tailwind CSS, accessibility, responsive behavior, motion, component states, and common anti-patterns to avoid.
...
- "This specific agent should..."
- "Only one agent vendor must..."
- "This IDE assistant can ignore..."
